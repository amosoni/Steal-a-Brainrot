...
export default function StealALabubuGuide({ params }: StealALabubuGuideProps) {
  ...
  return (
    <>
      <SEOHead
        title={t('guides.stealALabubu.seoTitle') as string}
        description={t('guides.stealALabubu.seoDescription') as string}
        keywords={t('guides.stealALabubu.seoKeywords') as string}
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-gradient-to-r from-pink-50 to-purple-50 rounded-xl p-6 mb-6">
                ...
                <div className="bg-white rounded-lg p-4">
                  ...
                  <ul className="space-y-2 text-gray-700">
                    {Array.isArray(t('guides.stealALabubu.gameFeaturesList')) ? 
                      (t('guides.stealALabubu.gameFeaturesList') as string[]).map((feature: string, index: number) => (
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-gradient-to-br from-gray-50 to-pink-50 rounded-xl p-6">
                  ...
                  <div className="bg-white rounded-lg p-3">
                    ...
                    <ul className="space-y-1 text-gray-700 text-sm">
                      {Array.isArray(t('guides.stealALabubu.commonLabubu.features')) ? 
                        (t('guides.stealALabubu.commonLabubu.features') as string[]).map((feature: string, index: number) => (
                          <li key={index} className="flex items-start">
                ...
                <div className="bg-gradient-to-br from-pink-50 to-purple-50 rounded-xl p-6">
                  ...
                  <div className="bg-white rounded-lg p-3">
                    ...
                    <ul className="space-y-1 text-gray-700 text-sm">
                      {Array.isArray(t('guides.stealALabubu.rareLabubu.features')) ? 
                        (t('guides.stealALabubu.rareLabubu.features') as string[]).map((feature: string, index: number) => (
                          <li key={index} className="flex items-start">
                ...
                <div className="bg-gradient-to-br from-purple-50 to-indigo-50 rounded-xl p-6">
                  ...
                  <div className="bg-white rounded-lg p-3">
                    ...
                    <ul className="space-y-1 text-gray-700 text-sm">
                      {Array.isArray(t('guides.stealALabubu.legendaryLabubu.features')) ? 
                        (t('guides.stealALabubu.legendaryLabubu.features') as string[]).map((feature: string, index: number) => (
                          <li key={index} className="flex items-start">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-gradient-to-br from-pink-50 to-purple-50 rounded-xl p-6">
                  ...
                  <div className="bg-white rounded-lg p-3">
                    ...
                    <ul className="space-y-1 text-gray-700 text-sm">
                      {Array.isArray(t('guides.stealALabubu.targetedCollection.tipsList')) ? 
                        (t('guides.stealALabubu.targetedCollection.tipsList') as string[]).map((tip: string, index: number) => (
                          <li key={index} className="flex items-start">
                ...
                <div className="bg-gradient-to-br from-purple-50 to-indigo-50 rounded-xl p-6">
                  ...
                  <div className="bg-white rounded-lg p-3">
                    ...
                    <ul className="space-y-1 text-gray-700 text-sm">
                      {Array.isArray(t('guides.stealALabubu.communityTrading.tipsList')) ? 
                        (t('guides.stealALabubu.communityTrading.tipsList') as string[]).map((tip: string, index: number) => (
                          <li key={index} className="flex items-start">
            ...
            <div id="faq" className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="space-y-6">
                {Array.isArray(t('guides.stealALabubu.faq.questions')) ? 
                  (t('guides.stealALabubu.faq.questions') as Array<{question: string, answer: string}>).map((faq, index: number) => (
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <ul className="space-y-2 text-gray-700">
                {Array.isArray(t('guides.stealALabubu.prerequisites.list')) ? 
                  (t('guides.stealALabubu.prerequisites.list') as string[]).map((prereq: string, index: number) => (
                    <li key={index} className="flex items-start">
